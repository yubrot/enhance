...
| Storage Abstraction | VFS (Trait-based) | Allows seamless switching between MemoryStorage and FileStorage (Disk).
...
* Week 5: VFS Trait & Memory Implementation: Define the Storage trait. Implement a memory-backed buffer for rapid testing.
* Week 6: File Storage Implementation: Use tokio::fs to read/write 8KB blocks using seek.
* Week 7: Buffer Pool Manager (Core): Implement fetch_page and unpin_page. Map PageId to memory Frames.
