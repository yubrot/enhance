...
We'll follow a **lazy hint bit strategy** (the same approach PostgreSQL uses): Hint bits are NOT set during abort (which would require tracking all written tuples). Instead:
